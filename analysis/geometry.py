...
def create_geometry_from_dxf(dxf_filepath, material):
    ...
    # Use the direct method from sectionproperties, just like in your working example
...
def create_compound_geometry(components, mesh_size=20):
    ...
    compound_geom = CompoundGeometry([first_geometry])
    ...
    for dxf_path, material in components[1:]:
        ...
        # Add to compound geometry using += operator
        compound_geom += geometry
